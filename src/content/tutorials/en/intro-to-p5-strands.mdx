...
- Inside your callback, use the strand blocks such as `finalColor` to specify how your shader will be different from the default.
...
- [`buildNormalShader`](/reference/p5/buildNormalShader): Builds a default normally applied by calling `normalMaterial()`.
