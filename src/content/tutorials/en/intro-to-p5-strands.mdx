...
flowchart TD
  ...
  subgraph Vertex_Shader ["Vertex Shader Pipeline"]
      ...
      OBJ -.-> INOBJ[[objectInputs]]
      INOBJ -.-> WORLD[World Space]
      WORLD -.-> INWLD[[worldInputs]]
      INWLD -.-> CAM[Camera/View Space]
      CAM -.-> INCAM[[cameraInputs]]
  ...
  subgraph Fragment_Shader ["Fragment Shader Pipeline"]
      ...
      L_MAT -.-> INPIX[[pixelInputs]]
      INPIX -.-> BLEND[Color Blending]
      BLEND -.-> COMB[[combineColors / getColor]]
      COMB -.-> FIN[Final Output Processing]
      FIN -.-> FCOLR[[finalColor]]
      FCOLR --> AF[[afterFragment]]
  end
  AF --> End([Screen Output])
  
  click INOBJ "https://beta.p5js.org/reference/#/p5.Shader" "p5.js Shader Reference"
  click INWLD "https://beta.p5js.org/reference/#/p5.Shader" "p5.js Shader Reference"
  click INCAM "https://beta.p5js.org/reference/#/p5.Shader" "p5.js Shader Reference"
  click INPIX "https://beta.p5js.org/reference/#/p5.Shader" "p5.js Shader Reference"
  click FCOLR "https://beta.p5js.org/reference/#/p5.Shader" "p5.js Shader Reference"

  class INOBJ,INWLD,INCAM,INPIX,COMB,FCOLR hook
