...
flowchart TD
  ...
  subgraph Fragment_Shader ["Fragment Shader Pipeline"]
      ...
      FIN -.-> FCOL[[finalColor]]
      FCOL --> AF[[afterFragment]]
  end
  AF --> End([Screen Output])
  style BV fill:#fcc89a,stroke:#333
  style AV fill:#fcc89a,stroke:#333
  style BF fill:#fcc89a,stroke:#333
  style AF fill:#fcc89a,stroke:#333
  style INOBJ fill:#f96,stroke:#333
  style INWLD fill:#f96,stroke:#333
  style INCAM fill:#f96,stroke:#333
  style INPIX fill:#f96,stroke:#333
  style COMB fill:#f96,stroke:#333
  style FCOL fill:#f96,stroke:#333
```